...
const translations = {
    en: {
        ...
        exp_mutatit_title: 'Full Stack Web Developer',
        exp_mutatit_date: 'Jan 2026 – Present',
        exp_mutatit_task1: 'Develop websites and web applications (front-end & back-end), including UI design, API integration, database management, and feature implementation.',
        exp_mutatit_task2: 'Perform deployment, maintenance, and troubleshooting to ensure optimal, secure, and stable system operations.',
        badge_intern: 'Internship',
        org_title: 'Organizational Experience',
        badge_org: 'Organization',
        ...
        exp5_title: 'Marketplace Admin',
        exp5_date: 'Oct 2021 – Nov 2023',
        exp5_task1: 'Manage products in Shopee stores, such as uploading products, updating stock, prices, and creating promotions.',
        exp5_task2: 'Monitor sales and create store performance reports to help increase sales.',
        exp5_task3: 'Serve customer inquiries, process orders, arrange shipping, and handle customer complaints.',
    ...
    id: {
        ...
        exp_mutatit_title: 'Full Stack Web Developer',
        exp_mutatit_date: 'Januari 2026 – Sekarang',
        exp_mutatit_task1: 'Mengembangkan website dan aplikasi web (front-end & back-end), termasuk desain UI, integrasi API, pengelolaan database, dan implementasi fitur.',
        exp_mutatit_task2: 'Melakukan deployment, maintenance, serta troubleshooting untuk memastikan sistem berjalan optimal, aman, dan stabil.',
        ...
        exp5_title: 'Admin Marketplace',
        exp5_date: 'Oktober 2021 – November 2023',
        exp5_task1: 'Mengelola produk di toko Shopee, seperti upload produk, memperbarui stok, harga, dan membuat promo.',
        exp5_task2: 'Memantau penjualan serta membuat laporan performa toko untuk membantu meningkatkan penjualan.',
        exp5_task3: 'Melayani pertanyaan pelanggan, memproses pesanan, mengatur pengiriman, dan menangani komplain pelanggan.',
...
const galleryMobile = [
    ...
    { src: 'image/aplikasi-harsaedu/register.jpg', caption: 'Aplikasi HarsaEdu' },
    { src: 'image/aplikasi-harsaedu/home.png', caption: 'Aplikasi HarsaEdu' },
    { src: 'image/aplikasi-harsaedu/class-menu.jpg', caption: 'Aplikasi HarsaEdu' },
    { src: 'image/aplikasi-harsaedu/categories.jpg', caption: 'Aplikasi HarsaEdu' },
    { src: 'image/aplikasi-harsaedu/categories-dropdown.jpg', caption: 'Aplikasi HarsaEdu' },
    { src: 'image/aplikasi-harsaedu/subscription.jpg', caption: 'Aplikasi HarsaEdu' },
    { src: 'image/aplikasi-harsaedu/payment.jpg', caption: 'Aplikasi HarsaEdu' },
    { src: 'image/aplikasi-harsaedu/recommendation.jpg', caption: 'Aplikasi HarsaEdu' },
    { src: 'image/aplikasi-harsaedu/notifications.jpg', caption: 'Aplikasi HarsaEdu' },
    { src: 'image/aplikasi-harsaedu/profile-not-subscribed.jpg', caption: 'Aplikasi HarsaEdu' },
    { src: 'image/aplikasi-harsaedu/not-subscribed.jpg', caption: 'Aplikasi HarsaEdu' }
];
...
const galleryDzikir = [
    { src: 'image/dzikir/dzikir-1.png', caption: 'Aplikasi Dzikir' },
    { src: 'image/dzikir/dzikir-2.png', caption: 'Aplikasi Dzikir' },
    { src: 'image/dzikir/dzikir-3.png', caption: 'Aplikasi Dzikir' },
    { src: 'image/dzikir/dzikir-4.png', caption: 'Aplikasi Dzikir' },
    { src: 'image/dzikir/dzikir-5.png', caption: 'Aplikasi Dzikir' },
    { src: 'image/dzikir/dzikir-6.png', caption: 'Aplikasi Dzikir' },
    { src: 'image/dzikir/dzikir-7.png', caption: 'Aplikasi Dzikir' },
    { src: 'image/dzikir/dzikir-8.png', caption: 'Aplikasi Dzikir' },
    { src: 'image/dzikir/dzikir-9.png', caption: 'Aplikasi Dzikir' },
    { src: 'image/dzikir/dzikir-10.png', caption: 'Aplikasi Dzikir' },
    { src: 'image/dzikir/dzikir-11.png', caption: 'Aplikasi Dzikir' }
];
...
const galleryPinjam = [
    { src: 'image/pinjam-barang/borrow-1.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-2.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-3.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-4.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-5.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-6.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-7.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-8.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-9.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-10.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-11.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-12.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-13.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-14.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-15.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-16.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-17.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-18.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-19.png', caption: 'Aplikasi Pinjam Barang' },
    { src: 'image/pinjam-barang/borrow-20.png', caption: 'Aplikasi Pinjam Barang' }
];
